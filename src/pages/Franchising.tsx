...
const Franchising = () => {
  ...
  return (
    <div className="pt-24 pb-12 sm:pt-32 sm:pb-16 bg-[#FD5121] min-h-screen">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-10 sm:mb-16">
          <motion.h1 
            ...
            className="text-3xl sm:text-4xl md:text-5xl font-bold text-[#000000] mb-9 sm:mb-4"
          >
    ...
    <div className="text-center text-white">
      ...
      <p className="text-xs sm:text-base md:text-xl max-w-md sm:max-w-xl mx-auto">
        ...
        <div className="mb-12 sm:mb-16 px-2 sm:px-0">
          <h2 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-white">Why Franchise With Us?</h2>
          <div className="grid grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-4">
            ...
            >
              <div className="w-12 h-12 sm:w-16 sm:h-16 bg-[#FD5121] border-2 border-white rounded-full flex items-center justify-center mx-auto mb-3 sm:mb-4">
        ...
        {/* Steps */}
        <div className="mb-12 sm:mb-16 px-2 sm:px-0">
          <h2 className="text-xl sm:text-2xl font-bold mb-6 sm:mb-8 text-white">Franchising Process</h2>
          <div className="space-y-4 sm:space-y-6">
            ...
            >
              <div className="bg-[#FD5121] text-white border-2 border-white text-xl sm:text-2xl font-bold w-10 h-10 sm:w-12 sm:h-12 rounded-full flex items-center justify-center flex-shrink-0 mr-3 sm:mr-4">
                1
              </div>
              <div>
                <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2 text-white">Initial Inquiry</h3>
            ...
            >
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2 text-white">Discovery Meeting</h3>
                <p className="text-sm sm:text-base text-white/80">
            ...
            >
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2 text-white">Financial Review & Approval</h3>
                <p className="text-sm sm:text-base text-white/80">
            ...
            >
              ...
              <div>
                <h3 className="text-lg sm:text-xl font-bold mb-1 sm:mb-2 text-white">Agreement & Training</h3>
                <p className="text-sm sm:text-base text-white/80">
        ...
        {/* Call to Action */}
        <div className="bg-white rounded-lg p-6 sm:p-8 text-center mx-2 sm:mx-0">
          ...
          <button
            ...
            className="inline-block bg-[#FD5121] text-white px-6 py-2 sm:px-8 sm:py-3 rounded-md hover:bg-[#e64444] transition-colors font-medium text-sm sm:text-base"
          >
            Apply Now
          </button>
        </div>
