      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10 md:mb-16">
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 text-[#292727] relative inline-block">
            ...
            <span
              className="absolute bottom-0 left-0 w-full h-2 bg-[#FE5000]/30 -z-0"
        ...
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-16 items-start">
          ...
          <div
            ...
            style={{ opacity: 0 }}
          >
            <div className="space-y-6 text-justify bg-white rounded-xl p-6 sm:p-8 shadow-lg relative before:absolute before:top-0 before:left-0 before:w-2 before:h-full before:bg-gradient-to-b from-[#FE5000] to-[#A16207]">
