...
const Career = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 p-4 md:p-8 relative overflow-hidden">
      ...
      {/* Images en position absolue avec animation et responsive */}
      {/* cachées sur mobile, visibles sur md+ */}
      <motion.img
        ...
        className="hidden md:block absolute top-20 right-10 w-1/3 max-w-xs select-none pointer-events-none rotate-6"
      ...
      <motion.img
        ...
        animate={{ opacity: 0.7, x: 0 }}
        transition={{ duration: 1 }}
        className="hidden md:block absolute bottom-20 left-10 w-1/4 max-w-xs select-none pointer-events-none -rotate-6"
        style={{ userSelect: 'none' }}
      />
